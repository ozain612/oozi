...
class CRDSetup:
    ...
    @staticmethod
    def installsunshine():
        subprocess.run(["wget", "https://github.com/LizardByte/Sunshine/releases/download/v0.23.1/sunshine-ubuntu-24.04-amd64.deb"])
        subprocess.run(["dpkg", "--install", "sunshine-ubuntu-24.04-amd64.deb"])
        subprocess.run(['apt', 'install', '--assume-yes', '--fix-broken'])
